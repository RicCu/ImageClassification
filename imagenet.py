"""Script to train image classification models on ImageNet.

This is based on PyTorch's official examples:
...
model_names += sorted(name for name in ic_models.__dict__
                      if name.islower() and not name.startswith("__")
                      and callable(ic_models.__dict__[name]))
